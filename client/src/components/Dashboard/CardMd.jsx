...
function CardMd (props) {
  ...
  const timeImage = hour >= 5 && hour < 12
    ? morningImage
    : hour >= 12 && hour < 17
        ? afternoonImage
        : hour >= 17 && hour < 20 ? eveningImage : nightImage;
  ...
  const cardColor = hour >= 5 && hour < 12
    ? '#FFD65A'
    : hour >= 12 && hour < 17
        ? 'Afternoon'
        : hour >= 17 && hour < 20 ? '#E7FBB4' : '#FFFAEC';
